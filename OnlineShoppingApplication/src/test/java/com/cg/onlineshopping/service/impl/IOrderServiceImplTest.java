...
public class IOrderServiceImplTest {
	...
	{
		List<InputOrder> order =service.viewAllOrderByDate(LocalDate.of(2021, 04, 12));
		assertNotNull(order, "Order found");	
	}
	@Test
	public void orderByIdUnitTest()
	{
		List<InputOrder> order =service.viewAllOrderByCustomerId(2);
		assertNotNull(order, "Order found !!");
	}
	...
	{
		List<InputOrder> order =service.viewAllOrdersByLocation("pune");
		assertNotNull(order, "Order found !!");
}
